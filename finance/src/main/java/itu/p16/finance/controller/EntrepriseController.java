...
public class EntrepriseController {
    ...
    @GetMapping("/edit/{id}")
    public ModelAndView editEntrepriseForm(@PathVariable Integer id) {
    ...
    @PostMapping("/edit/{id}")
    public ModelAndView updateEntreprise(@PathVariable Integer id, @ModelAttribute Entreprise entreprise) {
    ...
    public ModelAndView deleteEntrepriseForm(@PathVariable Integer id) {
